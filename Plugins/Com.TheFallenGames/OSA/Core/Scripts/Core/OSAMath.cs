...
namespace Com.ForbiddenByte.OSA.Core
{
    public class OSAMath
    {
        ...
        public static Func<double, double> GetLerpFunction(AnimationFunctionType animationFunctionType)
        {
            ...
            {
                case AnimationFunctionType.LINEAR: return Lerp_Linear;

                case AnimationFunctionType.SLOW_OUT: return Lerp_SinSlowOut;

                case AnimationFunctionType.FAST_IN_SLOW_OUT: return Lerp_SqrtFastInSlowOut;

                case AnimationFunctionType.SLOW_IN_OUT: return Lerp_ExpSlowInOut;

                default: throw new OSAException("AnimationFunctionType not handled: " + animationFunctionType);
            }
        }
    }
}