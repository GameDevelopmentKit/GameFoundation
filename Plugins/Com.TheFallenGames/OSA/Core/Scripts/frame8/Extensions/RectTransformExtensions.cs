...
namespace frame8.Logic.Misc.Other.Extensions
{
    ...
    {
        private static Func<RectTransform, RectTransform, float>[] _GetInsetFromParentEdge_MappedActions =
        ...
        public static Vector2 GetBottomLeftCornerDisplacementFromParentBottomLeftCorner(this RectTransform rt)
        {
            ...
            var locPos     = rt.localPosition;
            return new(rect.x - parentRect.x + locPos.x, rect.y - parentRect.y + locPos.y);
        }
        ...
        {
            var parentPivotXDistToParentLeft = parentPivot.x * parentRect.width;
            var childLocPosX                 = child.localPosition.x;
        ...
        {
            var parentPivotXDistToParentRight = (1f - parentPivot.x) * parentRect.width;
            var childLocPosX                  = child.localPosition.x;
        ...
        {
            var parentPivotYDistToParentTop = (1f - parentPivot.y) * parentRect.height;
            var childLocPosY                = child.localPosition.y;
        ...
        {
            var parentPivotYDistToParentBottom = parentPivot.y * parentRect.height;
            var childLocPosY                   = child.localPosition.y;
        ...
        private static void AfterSetInsetAndSizeFromParentEdgeWithCurrentAnchors_RestoreAnchorsIfNeeded(
