...
public class TimelinePlayableWizard : EditorWindow
{
    ...
    */
    ...
    readonly GUIContent m_BehaviourVariablesContent = new GUIContent("Behaviour Variables",
    ...
    readonly GUIContent m_CCBlendingContent =
    ...
    readonly GUIContent m_CreateDrawerContent = new GUIContent("Create Drawer?",
    ...
    readonly GUIContent m_ExposedReferencesContent = new GUIContent("Exposed References",
    ...
    readonly GUIContent m_StandardBlendPlayablePropertiesContent = new GUIContent("Standard Blend Playable Properties",
    ...
    readonly GUIContent m_TrackBindingTypeContent = new GUIContent("Track Binding Type",
    ...
    void OnGUI()
    {
        ...
        bool playableNameFormatted = true;
    ...
    CreationError CreateScripts()
    {
        ...
        if (isStandardBlendPlayable)
        {
            ...
            string path = Application.dataPath + "/" + playableName + "/Editor/" + playableName +
    ...
    string StandardBlendComponentBindingToString() { return "[TrackBindingType(typeof(" + trackBinding.name + "))]\n"; }
    ...
    string StandardBlendTrackBindingPropertiesAsSerializedPropsDeclarationToString()
    {
        ...
        {
            UsableProperty prop = standardBlendPlayableProperties[i];
            returnVal += k_Tab + k_Tab + "SerializedProperty " + prop.NameAsLocalSerializedProperty +
                         " = property.FindPropertyRelative(\"" + prop.name + "\");\n";
        }
    ...
    public class UsableProperty : IComparable
    {
        ...
        public string NameWithCaptial { get { return name.First().ToString().ToUpper() + name.Substring(1); } }

        public string NameAsPrivate { get { return "m_" + NameWithCaptial; } }

        public string NameAsPrivateDefault { get { return "m_Default" + NameWithCaptial; } }

        public string NameAsPrivateAssigned { get { return "m_Assigned" + NameWithCaptial; } }

        public string NameAsLocalBlended { get { return "blended" + NameWithCaptial; } }

        public string NameAsLocalSerializedProperty { get { return name + "Prop"; } }
