namespace I2.Loc
{
    ...
    public static class GoogleLanguages
    {
        ...
        {
	        var DefaultCode = GetLanguageCode(Language);
        ...
        public static void UnPackCodeFromLanguageName(string CodedLanguage, out string Language, out string code)
        {
            ...
            var Index = CodedLanguage.IndexOf("[", StringComparison.Ordinal);
            if (Index < 0)
            {
        ...
        public static string GetLanguageName(string code, bool useParenthesesForRegion=false, bool allowDiscardRegion=true)
        {
            ...
            {
	            var iCode = code.IndexOf("-", StringComparison.Ordinal);
                if (iCode > 0)
			...
			switch (rule) 
			{
				...
				case 15: // Families: Celtic (Breton)
					return n % 10 == 1 && n % 100 != 11 && n % 100 != 71 && n % 100 != 91 ? ePluralType.One :
						...
						(n % 10 == 3 || n % 10 == 4 || n % 10 == 9) && n % 100 != 13 && n % 100 != 14 && n % 100 != 19 && n % 100 != 73 && n % 100 != 74 && n % 100 != 79 && n % 100 != 93 &&
						n % 100 != 94 && n % 100 != 99 ? ePluralType.Few :
