...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1
{
		...
		: DerSequence
	{
		...
		internal override int EncodedLength(bool withID) { throw Platform.CreateNotImplementedException("BerSequence.EncodedLength"); }

		internal override void Encode(Asn1OutputStream asn1Out, bool withID)
		{
			if (asn1Out.IsBer)
				asn1Out.WriteEncodingIL(withID, Asn1Tags.Constructed | Asn1Tags.Sequence, this.elements);
			else
