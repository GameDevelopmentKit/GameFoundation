...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class CertChainType
    {
        ...
        public static string GetText(short certChainType) { return GetName(certChainType) + "(" + certChainType + ")"; }

        public static bool IsValid(short certChainType) { return certChainType >= individual_certs && certChainType <= pkipath; }
    }
}
