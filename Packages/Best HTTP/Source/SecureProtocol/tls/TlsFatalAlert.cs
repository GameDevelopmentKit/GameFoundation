...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : TlsException
    {
        ...
        {
            var msg                        = Tls.AlertDescription.GetText(alertDescription);
            if (null != detailMessage) msg += "; " + detailMessage;
            return msg;
        }
        ...
        public virtual short AlertDescription => this.m_alertDescription;
    }
}
