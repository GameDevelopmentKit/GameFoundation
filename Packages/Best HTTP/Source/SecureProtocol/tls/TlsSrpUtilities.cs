...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class TlsSrpUtilities
    {
        ...
        public static void AddSrpExtension(IDictionary extensions, byte[] identity) { extensions[ExtensionType.srp] = CreateSrpExtension(identity); }

        /// <exception cref="IOException" />
        public static byte[] GetSrpExtension(IDictionary extensions)
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.srp);
        ...
        /// <exception cref="IOException" />
        public static BigInteger ReadSrpParameter(Stream input) { return new BigInteger(1, TlsUtilities.ReadOpaque16(input, 1)); }
