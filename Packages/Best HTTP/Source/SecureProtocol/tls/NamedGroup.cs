...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class NamedGroup
    {
        ...
        private static readonly string[] FiniteFieldNames =
        {
        ...
        {
            if (RefersToASpecificCurve(namedGroup)) return CurveNames[namedGroup - sect163k1];
        ...
        {
            if (RefersToASpecificFiniteField(namedGroup)) return FiniteFieldNames[namedGroup - ffdhe2048];

            return null;
        }

        public static int GetMaximumChar2CurveBits() { return 571; }

        public static int GetMaximumCurveBits() { return 571; }

        public static int GetMaximumFiniteFieldBits() { return 8192; }

        public static int GetMaximumPrimeCurveBits() { return 521; }

        public static string GetName(int namedGroup)
        {
            if (IsPrivate(namedGroup)) return "PRIVATE";
            ...
            var standardName = GetStandardName(namedGroup);
            if (null != standardName) return standardName;
        ...
        {
            var curveName = GetCurveName(namedGroup);
            if (null != curveName) return curveName;

            var finiteFieldName = GetFiniteFieldName(namedGroup);
            if (null != finiteFieldName) return finiteFieldName;

            return null;
        }

        public static string GetText(int namedGroup) { return GetName(namedGroup) + "(" + namedGroup + ")"; }
        ...
        public static bool IsPrivate(int namedGroup) { return namedGroup >> 2 == 0x7F || namedGroup >> 8 == 0xFE; }
        ...
        public static bool RefersToAnECDHCurve(int namedGroup) { return RefersToASpecificCurve(namedGroup); }
        ...
        public static bool RefersToAnXDHCurve(int namedGroup) { return namedGroup >= x25519 && namedGroup <= x448; }

        public static bool RefersToASpecificCurve(int namedGroup) { return namedGroup >= sect163k1 && namedGroup <= curveSM2; }

        public static bool RefersToASpecificFiniteField(int namedGroup) { return namedGroup >= ffdhe2048 && namedGroup <= ffdhe8192; }
