...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : AbstractTlsClient
    {
        ...
        public override IDictionary GetClientExtensions()
        {
            ...
            TlsSrpUtilities.AddSrpExtension(clientExtensions, this.m_srpIdentity.GetSrpIdentity());
        ...
        public override void ProcessServerExtensions(IDictionary serverExtensions)
        {
            if (!TlsUtilities.HasExpectedEmptyExtensionData(serverExtensions, ExtensionType.srp,
                ...
                if (this.RequireSrpServerExtension)
                    throw new TlsFatalAlert(AlertDescription.illegal_parameter);

            base.ProcessServerExtensions(serverExtensions);
        }

        public override TlsSrpIdentity GetSrpIdentity() { return this.m_srpIdentity; }
