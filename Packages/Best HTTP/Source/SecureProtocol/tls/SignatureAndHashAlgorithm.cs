...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public sealed class SignatureAndHashAlgorithm
    {
        ...
        private static SignatureAndHashAlgorithm Create(short hashAlgorithm, short signatureAlgorithm) { return new SignatureAndHashAlgorithm(hashAlgorithm, signatureAlgorithm); }

        /// <param name="hash">
        ///     <see cref="HashAlgorithm" />
        /// </param>
        /// <param name="signature">
        ///     <see cref="SignatureAlgorithm" />
        /// </param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return other.Hash == this.Hash && other.Signature == this.Signature;
        }

        public override int GetHashCode() { return (this.Hash << 16) | this.Signature; }

        public override string ToString() { return "{" + HashAlgorithm.GetText(this.Hash) + "," + SignatureAlgorithm.GetText(this.Signature) + "}"; }
    }
}
