...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto
{
    ...
    public interface TlsCrypto
    {
        ...
        /// <summary>
        ///     Return true if this TlsCrypto supports the passed in <see cref="NamedGroup">named group</see>
        ///     value.
        /// </summary>
        /// <returns>
        ///     true if this instance supports the passed in <see cref="NamedGroup">named group</see> value.
        /// </returns>
        ...
        ///     zeroes.
        /// </summary>
        /// <param name="cryptoHashAlgorithm">
        ///     the hash algorithm to instantiate HMAC with. See
        ///     <see cref="CryptoHashAlgorithm" /> for values.
        /// </param>
