...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto
{
    ...
    public class DHStandardGroups
    {
        ...
        private static DHGroup SafePrimeGen2(string hexP) { return SafePrimeGen2(hexP, 0); }
        ...
        private static readonly int     rfc3526_2048_l = Math.Max(225, 112 * 2); // MAX(RFC3526/RFC7919,FIPS)
        ...
        private static readonly int     rfc3526_3072_l = Math.Max(275, 128 * 2); // MAX(RFC3526/RFC7919,FIPS)
        ...
        private static readonly int     rfc3526_4096_l = Math.Max(325, 152 * 2); // MAX(RFC3526/RFC7919,FIPS)
        ...
        private static readonly int     rfc3526_6144_l = Math.Max(375, 176 * 2); // MAX(RFC3526/RFC7919,FIPS)
        ...
        private static readonly int     rfc3526_8192_l = Math.Max(400, 200 * 2); // MAX(RFC3526/RFC7919,FIPS)
        ...
        private static readonly int     rfc7919_ffdhe2048_l = Math.Max(225, 112 * 2); // MAX(RFC7919,FIPS)
        ...
        private static readonly int     rfc7919_ffdhe3072_l = Math.Max(275, 128 * 2); // MAX(RFC7919,FIPS)
        ...
        private static readonly int     rfc7919_ffdhe4096_l = Math.Max(325, 152 * 2); // MAX(RFC7919,FIPS)
        ...
        private static readonly int     rfc7919_ffdhe6144_l = Math.Max(375, 176 * 2); // MAX(RFC7919,FIPS)
        ...
        private static readonly int     rfc7919_ffdhe8192_l = Math.Max(400, 200 * 2); // MAX(RFC7919,FIPS)
