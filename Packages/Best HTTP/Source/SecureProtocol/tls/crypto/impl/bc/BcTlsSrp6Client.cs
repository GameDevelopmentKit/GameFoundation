...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto.Impl.BC
{
        ...
        : TlsSrp6Client
    {
        ...
        public BigInteger GenerateClientCredentials(byte[] srpSalt, byte[] identity, byte[] password) { return this.m_srp6Client.GenerateClientCredentials(srpSalt, identity, password); }
    }
}
