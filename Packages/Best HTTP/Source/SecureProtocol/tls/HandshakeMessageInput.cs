...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : MemoryStream
    {
        ...
        public void UpdateHash(TlsHash hash) { Streams.WriteBufTo(this, new TlsHashSink(hash)); }
        ...
        internal void UpdateHashPrefix(TlsHash hash, int bindersSize)
        {
            ...
            hash.Update(buf, this.m_offset, count - bindersSize);
        }
        ...
        internal void UpdateHashSuffix(TlsHash hash, int bindersSize)
        {
            ...
            hash.Update(buf, this.m_offset + count - bindersSize, bindersSize);
        }
    }
}
