...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    {
        public static IDictionary EnsureExtensionsInitialised(IDictionary extensions) { return extensions == null ? Platform.CreateHashtable() : extensions; }
        ...
        public static void AddClientCertificateUrlExtension(IDictionary extensions) { extensions[ExtensionType.client_certificate_url] = CreateClientCertificateUrlExtension(); }

        /// <exception cref="IOException" />
        public static void AddCookieExtension(IDictionary extensions, byte[] cookie) { extensions[ExtensionType.cookie] = CreateCookieExtension(cookie); }

        public static void AddEarlyDataIndication(IDictionary extensions) { extensions[ExtensionType.early_data] = CreateEarlyDataIndication(); }

        /// <exception cref="IOException" />
        public static void AddEarlyDataMaxSize(IDictionary extensions, long maxSize) { extensions[ExtensionType.early_data] = CreateEarlyDataMaxSize(maxSize); }

        public static void AddEmptyExtensionData(IDictionary extensions, int extType) { extensions[extType] = CreateEmptyExtensionData(); }

        public static void AddEncryptThenMacExtension(IDictionary extensions) { extensions[ExtensionType.encrypt_then_mac] = CreateEncryptThenMacExtension(); }

        public static void AddExtendedMasterSecretExtension(IDictionary extensions) { extensions[ExtensionType.extended_master_secret] = CreateExtendedMasterSecretExtension(); }

        /// <exception cref="IOException" />
        public static void AddHeartbeatExtension(IDictionary extensions, HeartbeatExtension heartbeatExtension) { extensions[ExtensionType.heartbeat] = CreateHeartbeatExtension(heartbeatExtension); }

        /// <exception cref="IOException" />
        public static void AddKeyShareClientHello(IDictionary extensions, IList clientShares) { extensions[ExtensionType.key_share] = CreateKeyShareClientHello(clientShares); }

        /// <exception cref="IOException" />
        public static void AddKeyShareHelloRetryRequest(IDictionary extensions, int namedGroup) { extensions[ExtensionType.key_share] = CreateKeyShareHelloRetryRequest(namedGroup); }

        /// <exception cref="IOException" />
        public static void AddKeyShareServerHello(IDictionary extensions, KeyShareEntry serverShare) { extensions[ExtensionType.key_share] = CreateKeyShareServerHello(serverShare); }
        ...
        /// <exception cref="IOException" />
        public static void AddOidFiltersExtension(IDictionary extensions, IDictionary filters) { extensions[ExtensionType.oid_filters] = CreateOidFiltersExtension(filters); }

        /// <exception cref="IOException" />
        public static void AddPaddingExtension(IDictionary extensions, int dataLength) { extensions[ExtensionType.padding] = CreatePaddingExtension(dataLength); }

        public static void AddPostHandshakeAuthExtension(IDictionary extensions) { extensions[ExtensionType.post_handshake_auth] = CreatePostHandshakeAuthExtension(); }

        /// <exception cref="IOException" />
        public static void AddPreSharedKeyClientHello(IDictionary extensions, OfferedPsks offeredPsks) { extensions[ExtensionType.pre_shared_key] = CreatePreSharedKeyClientHello(offeredPsks); }

        /// <exception cref="IOException" />
        public static void AddPreSharedKeyServerHello(IDictionary extensions, int selectedIdentity) { extensions[ExtensionType.pre_shared_key] = CreatePreSharedKeyServerHello(selectedIdentity); }

        /// <exception cref="IOException" />
        public static void AddPskKeyExchangeModesExtension(IDictionary extensions, short[] modes) { extensions[ExtensionType.psk_key_exchange_modes] = CreatePskKeyExchangeModesExtension(modes); }

        /// <exception cref="IOException" />
        public static void AddRecordSizeLimitExtension(IDictionary extensions, int recordSizeLimit) { extensions[ExtensionType.record_size_limit] = CreateRecordSizeLimitExtension(recordSizeLimit); }
        ...
        /// <exception cref="IOException" />
        public static void AddServerNameExtensionClient(IDictionary extensions, IList serverNameList) { extensions[ExtensionType.server_name] = CreateServerNameExtensionClient(serverNameList); }

        /// <exception cref="IOException" />
        public static void AddServerNameExtensionServer(IDictionary extensions) { extensions[ExtensionType.server_name] = CreateServerNameExtensionServer(); }
        ...
        /// <exception cref="IOException" />
        public static void AddStatusRequestV2Extension(IDictionary extensions, IList statusRequestV2) { extensions[ExtensionType.status_request_v2] = CreateStatusRequestV2Extension(statusRequestV2); }

        /// <exception cref="IOException" />
        public static void AddSupportedGroupsExtension(IDictionary extensions, IList namedGroups) { extensions[ExtensionType.supported_groups] = CreateSupportedGroupsExtension(namedGroups); }
        ...
        public static void AddTruncatedHmacExtension(IDictionary extensions) { extensions[ExtensionType.truncated_hmac] = CreateTruncatedHmacExtension(); }
        ...
        public static void AddTrustedCAKeysExtensionServer(IDictionary extensions) { extensions[ExtensionType.trusted_ca_keys] = CreateTrustedCAKeysExtensionServer(); }
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.application_layer_protocol_negotiation);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.certificate_authorities);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.client_certificate_type);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.cookie);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.early_data);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.heartbeat);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.key_share);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.max_fragment_length);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.oid_filters);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.padding);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.pre_shared_key);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.psk_key_exchange_modes);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.record_size_limit);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.server_certificate_type);
            return extensionData == null ? null : ReadCertificateTypeExtensionClient(extensionData);
        }
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.server_name);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.signature_algorithms);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.signature_algorithms_cert);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.status_request);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.status_request_v2);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.supported_groups);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.ec_point_formats);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.supported_versions);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.trusted_ca_keys);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.client_certificate_url);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.encrypt_then_mac);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.extended_master_secret);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.post_handshake_auth);
        ...
        {
            var extensionData = TlsUtilities.GetExtensionData(extensions, ExtensionType.truncated_hmac);
        ...
        public static byte[] CreateAlpnExtensionClient(IList protocolNameList)
        {
            ...
            foreach (ProtocolName protocolName in protocolNameList) protocolName.Encode(buf);
        ...
        {
            var protocol_name_list = Platform.CreateArrayList();
        ...
        public static byte[] CreateCertificateAuthoritiesExtension(IList authorities)
        {
            ...
            {
                var derEncoding = authority.GetEncoded(Asn1Encodable.Der);
        ...
        /// <exception cref="IOException" />
        public static byte[] CreateCertificateTypeExtensionServer(short certificateType) { return TlsUtilities.EncodeUint8(certificateType); }

        public static byte[] CreateClientCertificateUrlExtension() { return CreateEmptyExtensionData(); }
        ...
        public static byte[] CreateEarlyDataIndication() { return CreateEmptyExtensionData(); }

        /// <exception cref="IOException" />
        public static byte[] CreateEarlyDataMaxSize(long maxSize) { return TlsUtilities.EncodeUint32(maxSize); }

        public static byte[] CreateEmptyExtensionData() { return TlsUtilities.EmptyBytes; }

        public static byte[] CreateEncryptThenMacExtension() { return CreateEmptyExtensionData(); }

        public static byte[] CreateExtendedMasterSecretExtension() { return CreateEmptyExtensionData(); }

        /// <exception cref="IOException" />
        public static byte[] CreateHeartbeatExtension(HeartbeatExtension heartbeatExtension)
        {
            if (heartbeatExtension == null) throw new TlsFatalAlert(AlertDescription.internal_error);
        ...
        public static byte[] CreateKeyShareClientHello(IList clientShares)
        {
            ...
            foreach (KeyShareEntry clientShare in clientShares) clientShare.Encode(buf);

            return PatchOpaque16(buf);
        }

        /// <exception cref="IOException" />
        public static byte[] CreateKeyShareHelloRetryRequest(int namedGroup) { return TlsUtilities.EncodeUint16(namedGroup); }

        /// <exception cref="IOException" />
        public static byte[] CreateKeyShareServerHello(KeyShareEntry serverShare)
        {
            if (serverShare == null) throw new TlsFatalAlert(AlertDescription.internal_error);
        ...
        /// <exception cref="IOException" />
        public static byte[] CreateMaxFragmentLengthExtension(short maxFragmentLength) { return TlsUtilities.EncodeUint8(maxFragmentLength); }
        ...
        public static byte[] CreateOidFiltersExtension(IDictionary filters)
        {
            ...
            if (null != filters)
                ...
                {
                    var certificateExtensionValues = (byte[])filters[certificateExtensionOid];

                    if (null == certificateExtensionOid || null == certificateExtensionValues)
                        throw new TlsFatalAlert(AlertDescription.internal_error);

                    var derEncoding = certificateExtensionOid.GetEncoded(Asn1Encodable.Der);
        ...
        public static byte[] CreatePostHandshakeAuthExtension() { return CreateEmptyExtensionData(); }
        ...
        /// <exception cref="IOException" />
        public static byte[] CreatePreSharedKeyServerHello(int selectedIdentity) { return TlsUtilities.EncodeUint16(selectedIdentity); }
        ...
        public static byte[] CreateServerNameExtensionServer() { return CreateEmptyExtensionData(); }
        ...
        /// <exception cref="IOException" />
        public static byte[] CreateSignatureAlgorithmsCertExtension(IList supportedSignatureAlgorithms) { return CreateSignatureAlgorithmsExtension(supportedSignatureAlgorithms); }
        ...
        public static byte[] CreateStatusRequestV2Extension(IList statusRequestV2)
        {
            ...
            foreach (CertificateStatusRequestItemV2 entry in statusRequestV2) entry.Encode(buf);
        ...
        public static byte[] CreateSupportedGroupsExtension(IList namedGroups)
        {
            ...
            var count                                 = namedGroups.Count;
            var values                                = new int[count];
            for (var i = 0; i < count; ++i) values[i] = (int)namedGroups[i];
        ...
        public static byte[] CreateSupportedVersionsExtensionClient(ProtocolVersion[] versions)
        {
            ...
            for (var i = 0; i < count; ++i) TlsUtilities.WriteVersion(versions[i], data, 1 + i * 2);
            return data;
        }

        /// <exception cref="IOException" />
        public static byte[] CreateSupportedVersionsExtensionServer(ProtocolVersion selectedVersion) { return TlsUtilities.EncodeVersion(selectedVersion); }
        ...
        public static byte[] CreateTrustedCAKeysExtensionServer() { return CreateEmptyExtensionData(); }
        ...
        public static IList ReadAlpnExtensionClient(byte[] extensionData)
        {
            ...
            var buf = new MemoryStream(extensionData);
            ...
            {
                var protocolName = ProtocolName.Parse(buf);
        ...
        public static IList ReadCertificateAuthoritiesExtension(byte[] extensionData)
        {
            ...
            var authorities = Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
        ...
        {
            var certificateTypes = TlsUtilities.DecodeUint8ArrayWithUint8Length(extensionData);
        ...
        /// <exception cref="IOException" />
        public static short ReadCertificateTypeExtensionServer(byte[] extensionData) { return TlsUtilities.DecodeUint8(extensionData); }

        /// <exception cref="IOException" />
        public static bool ReadClientCertificateUrlExtension(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }

        /// <exception cref="IOException" />
        public static byte[] ReadCookieExtension(byte[] extensionData) { return TlsUtilities.DecodeOpaque16(extensionData, 1); }

        /// <exception cref="IOException" />
        public static bool ReadEarlyDataIndication(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }

        /// <exception cref="IOException" />
        public static long ReadEarlyDataMaxSize(byte[] extensionData) { return TlsUtilities.DecodeUint32(extensionData); }

        /// <exception cref="IOException" />
        public static bool ReadEncryptThenMacExtension(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }

        /// <exception cref="IOException" />
        public static bool ReadExtendedMasterSecretExtension(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }
        ...
        public static HeartbeatExtension ReadHeartbeatExtension(byte[] extensionData)
        {
            ...
            var heartbeatExtension = HeartbeatExtension.Parse(buf);
        ...
        public static IList ReadKeyShareClientHello(byte[] extensionData)
        {
            ...
            var clientShares = Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
                var clientShare = KeyShareEntry.Parse(buf);
        ...
        /// <exception cref="IOException" />
        public static int ReadKeyShareHelloRetryRequest(byte[] extensionData) { return TlsUtilities.DecodeUint16(extensionData); }
        ...
        public static KeyShareEntry ReadKeyShareServerHello(byte[] extensionData)
        {
            ...
            var serverShare = KeyShareEntry.Parse(buf);
        ...
        /// <exception cref="IOException" />
        public static short ReadMaxFragmentLengthExtension(byte[] extensionData) { return TlsUtilities.DecodeUint8(extensionData); }
        ...
        public static IDictionary ReadOidFiltersExtension(byte[] extensionData)
        {
            ...
            var filters = Platform.CreateHashtable();
            while (buf.Position < buf.Length)
            {
                var derEncoding             = TlsUtilities.ReadOpaque8(buf, 1);
                var asn1                    = TlsUtilities.ReadDerObject(derEncoding);
                var certificateExtensionOid = DerObjectIdentifier.GetInstance(asn1);

                if (filters.Contains(certificateExtensionOid))
                    throw new TlsFatalAlert(AlertDescription.illegal_parameter);

                var certificateExtensionValues = TlsUtilities.ReadOpaque16(buf);
        ...
        /// <exception cref="IOException" />
        public static bool ReadPostHandshakeAuthExtension(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }
        ...
        public static OfferedPsks ReadPreSharedKeyClientHello(byte[] extensionData)
        {
            ...
            var offeredPsks = OfferedPsks.Parse(buf);
        ...
        /// <exception cref="IOException" />
        public static int ReadPreSharedKeyServerHello(byte[] extensionData) { return TlsUtilities.DecodeUint16(extensionData); }

        /// <exception cref="IOException" />
        public static short[] ReadPskKeyExchangeModesExtension(byte[] extensionData)
        {
            var modes = TlsUtilities.DecodeUint8ArrayWithUint8Length(extensionData);
            if (modes.Length < 1)
                throw new TlsFatalAlert(AlertDescription.decode_error);
        ...
        {
            var recordSizeLimit = TlsUtilities.DecodeUint16(extensionData);
            if (recordSizeLimit < 64)
                throw new TlsFatalAlert(AlertDescription.illegal_parameter);
        ...
        public static IList ReadServerNameExtensionClient(byte[] extensionData)
        {
            ...
            var serverNameList = ServerNameList.Parse(buf);
        ...
        /// <exception cref="IOException" />
        public static bool ReadServerNameExtensionServer(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }
        ...
        /// <exception cref="IOException" />
        public static IList ReadSignatureAlgorithmsCertExtension(byte[] extensionData) { return ReadSignatureAlgorithmsExtension(extensionData); }
        ...
        public static CertificateStatusRequest ReadStatusRequestExtension(byte[] extensionData)
        {
            ...
            var statusRequest = CertificateStatusRequest.Parse(buf);
        ...
        public static IList ReadStatusRequestV2Extension(byte[] extensionData)
        {
            ...
            var statusRequestV2 = Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
                var entry = CertificateStatusRequestItemV2.Parse(buf);
        ...
        public static int[] ReadSupportedGroupsExtension(byte[] extensionData)
        {
            ...
            var namedGroups = TlsUtilities.ReadUint16Array(length / 2, buf);
        ...
        {
            var ecPointFormats = TlsUtilities.DecodeUint8ArrayWithUint8Length(extensionData);
        ...
        public static ProtocolVersion[] ReadSupportedVersionsExtensionClient(byte[] extensionData)
        {
            ...
            var count                                   = length / 2;
            var versions                                = new ProtocolVersion[count];
            for (var i = 0; i < count; ++i) versions[i] = TlsUtilities.ReadVersion(extensionData, 1 + i * 2);
            return versions;
        }
        ...
        /// <exception cref="IOException" />
        public static bool ReadTruncatedHmacExtension(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }
        ...
        public static IList ReadTrustedCAKeysExtensionClient(byte[] extensionData)
        {
            ...
            var trusted_authorities_list = Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
                var entry = TrustedAuthority.Parse(buf);
        ...
        /// <exception cref="IOException" />
        public static bool ReadTrustedCAKeysExtensionServer(byte[] extensionData) { return ReadEmptyExtensionData(extensionData); }

        /// <exception cref="IOException" />
        private static byte[] PatchOpaque16(MemoryStream buf)
        {
            var length = (int)buf.Length - 2;
            TlsUtilities.CheckUint16(length);
            var extensionData = buf.ToArray();
