...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public interface TlsContext
    {
        ...
        /// </remarks>
        /// <returns>
        ///     A <see cref="TlsSession" /> representing the resumable session used by this connection, or null if
        ...
        ///     A <see cref="ChannelBinding" /> constant specifying the channel binding to
        ///     export.
        /// </param>
        /// <returns>
        ///     A copy of the channel binding data as a <c>byte[]</c>, or null if the binding could not be
        ///     determined.
        /// </returns>
