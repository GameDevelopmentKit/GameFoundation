...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities
{
    ...
    public abstract class Longs
    {
        ...
        public static int NumberOfTrailingZeros(long i)
        {
            ...
            var m = (((i & 0xFFFFFFFFL) | (long)((ulong)i >> 32)) - 1L) >> 63;
            return n - (int)m;
        }

        public static long Reverse(long i) { return (long)Reverse((ulong)i); }
        ...
        public static long ReverseBytes(long i) { return (long)ReverseBytes((ulong)i); }
        ...
        public static long RotateLeft(long i, int distance) { return (i << distance) ^ (long)((ulong)i >> -distance); }

        public static ulong RotateLeft(ulong i, int distance) { return (i << distance) ^ (i >> -distance); }

        public static long RotateRight(long i, int distance) { return (long)((ulong)i >> distance) ^ (i << -distance); }

        public static ulong RotateRight(ulong i, int distance) { return (i >> distance) ^ (i << -distance); }
    }
}
