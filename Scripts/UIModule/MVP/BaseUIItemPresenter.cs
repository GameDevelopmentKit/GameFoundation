namespace GameFoundation.Scripts.UIModule.MVP
{
    ...
    public interface IUIItemPresenter<TView, TModel> : IUIItemPresenter, IDisposable
    {
    ...
    public abstract class BaseUIItemPresenter<TView> : IUIItemPresenter where TView : MonoBehaviour, IUIView
    {
        ...
        public virtual async UniTask SetView(Transform parent)
        {
            ...
            {
                this.SetView(Object
                    .Instantiate(await this.GameAssets.LoadAssetAsync<GameObject>(this.PrefabPath), parent)
                    .GetComponent<TView>());
            }
        }
        ...
        public async UniTask SetView(Vector3 worldPosition)
        {
            if (this.View == null)
            {
                var view = Object.Instantiate(await this.GameAssets.LoadAssetAsync<GameObject>(this.PrefabPath))
                    .GetComponent<TView>();
                this.SetView(view);
    ...
    public abstract class BaseUIItemPresenter<TView, TModel> : BaseUIItemPresenter<TView>,
        IUIItemPresenter<TView, TModel>, IDisposable where TView : MonoBehaviour, IUIView
    {
    ...
    public abstract class BaseUIItemPresenter<TView, TModel1, TModel2> : BaseUIItemPresenter<TView>
    ...
    /// </summary>
    /// <typeparam name="TView">Type of view</typeparam>
    public abstract class BaseUIItemPoolablePresenter<TView> : BaseUIItemPresenter<TView>, IPoolable<IMemoryPool>,
        IDisposable where TView : MonoBehaviour, IUIView
    {
    ...
    public abstract class BaseUIItemPoolablePresenter<TView, TModel> : BaseUIItemPoolablePresenter<TView>,
        IUIItemPresenter<TView, TModel> where TView : MonoBehaviour, IUIView
    {
        public abstract void BindData(TModel param);
    ...
    public abstract class BaseUIItemPoolablePresenter<TView, TModel1, TModel2> : BaseUIItemPoolablePresenter<TView>
        where TView : MonoBehaviour, IUIView
    {
        public abstract void BindData(TModel1 param1, TModel2 param2);
