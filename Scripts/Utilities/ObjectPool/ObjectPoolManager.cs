namespace GameFoundation.Scripts.Utilities.ObjectPool
{
    ...
    public sealed class ObjectPoolManager
    {
        ...
        public bool IsSpawned(GameObject obj) {
            bool binhb = true;
            return this.spawnedObjToObjectPool.ContainsKey(obj);
        }
