#!/usr/bin/env python3
"""
Add random junk/dead code ONLY to Scripts folder in com.gdk.core package.
Excludes Plugins folder completely.
"""
...
def process_directory(directory):
    """Process all C# files in Scripts directory only"""
    total_files = 0
    total_methods = 0

    # Only process Scripts folder
...
def main():
    ...
    print("=" * 60)
    print("Adding random junk code to Scripts folder only")
    print("Excluding Plugins folder")
    print("=" * 60)

    # First, restore everything from git
    print("Restoring all files from git first...")
    os.chdir(script_dir)
    os.system("git checkout HEAD -- .")
    print("Files restored")
    print()

    # Process only Scripts folder
