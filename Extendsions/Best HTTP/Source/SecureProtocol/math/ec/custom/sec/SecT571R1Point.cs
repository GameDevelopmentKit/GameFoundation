...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            var X1 = (SecT571FieldElement)this.RawXCoord;
            var X2 = (SecT571FieldElement)b.RawXCoord;
            ...
            var t1 = Nat576.Create64();
            var t2 = Nat576.Create64();
            var t3 = Nat576.Create64();
            var t4 = Nat576.Create64();

            var     Z1Precomp = Z1.IsOne ? null : SecT571Field.PrecompMultiplicand(Z1.x);
            ulong[] U2, S2;
            if (Z1Precomp == null)
            {
                U2 = X2.x;
            ...
            var     Z2Precomp = Z2.IsOne ? null : SecT571Field.PrecompMultiplicand(Z2.x);
            ulong[] U1, S1;
            if (Z2Precomp == null)
            {
                U1 = X1.x;
            ...
            else
            {
                ...
                var APrecomp = SecT571Field.PrecompMultiplicand(A);
        ...
        public override ECPoint Twice()
        {
            ...
            var T = Nat576.Create64();
            SecT571Field.Square(L1.x, T);
            SecT571Field.AddBothTo(L1Z1, Z1Sq, T);

            if (Nat576.IsZero64(T)) return new SecT571R1Point(curve, new SecT571FieldElement(T), SecT571R1Curve.SecT571R1_B_SQRT, this.IsCompressed);

            var tt = Nat576.CreateExt64();
            SecT571Field.MultiplyAddToExt(T, L1Z1, tt);

            var X3 = new SecT571FieldElement(t1);
            SecT571Field.Square(T, X3.x);

            var Z3 = new SecT571FieldElement(T);
            if (Z1Precomp != null)
            {
            ...
            var L3 = new SecT571FieldElement(t2);
