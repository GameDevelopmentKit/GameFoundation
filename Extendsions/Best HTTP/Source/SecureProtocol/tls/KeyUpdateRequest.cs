...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class KeyUpdateRequest
    {
        ...
        public static string GetText(short keyUpdateRequest) { return GetName(keyUpdateRequest) + "(" + keyUpdateRequest + ")"; }

        public static bool IsValid(short keyUpdateRequest) { return keyUpdateRequest >= update_not_requested && keyUpdateRequest <= update_requested; }
    }
}
