...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    {
        public static ProtocolName AsRawBytes(byte[] bytes) { return new ProtocolName(Arrays.Clone(bytes)); }

        public static ProtocolName AsUtf8Encoding(string name) { return new ProtocolName(Strings.ToUtf8ByteArray(name)); }
        ...
        public byte[] GetBytes() { return Arrays.Clone(this.m_bytes); }

        public string GetUtf8Decoding() { return Strings.FromUtf8ByteArray(this.m_bytes); }
        ...
        /// <exception cref="IOException" />
        public static ProtocolName Parse(Stream input) { return new ProtocolName(TlsUtilities.ReadOpaque8(input, 1)); }

        public override bool Equals(object obj) { return obj is ProtocolName && Arrays.AreEqual(this.m_bytes, ((ProtocolName)obj).m_bytes); }

        public override int GetHashCode() { return Arrays.GetHashCode(this.m_bytes); }
    }
}
