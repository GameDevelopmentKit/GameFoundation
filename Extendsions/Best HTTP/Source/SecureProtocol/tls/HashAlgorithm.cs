...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class HashAlgorithm
    {
        ...
        public static string GetText(short hashAlgorithm) { return GetName(hashAlgorithm) + "(" + hashAlgorithm + ")"; }

        public static bool IsPrivate(short hashAlgorithm) { return 224 <= hashAlgorithm && hashAlgorithm <= 255; }
