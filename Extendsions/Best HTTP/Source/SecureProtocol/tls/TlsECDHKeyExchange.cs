...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : AbstractTlsKeyExchange
    {
        ...
        public override short[] GetClientCertificateTypes()
        {
             ...
             * these algorithms.
             */
            return new[] { ClientCertificateType.ecdsa_fixed_ecdh, ClientCertificateType.rsa_fixed_ecdh };
        }
        ...
        public override TlsSecret GeneratePreMasterSecret() { return this.m_agreementCredentials.GenerateAgreement(this.m_ecdhPeerCertificate); }
    }
}
