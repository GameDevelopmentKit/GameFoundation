...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : TlsPeer
    {
        ...
        protected AbstractTlsPeer(TlsCrypto crypto) { this.Crypto = crypto; }
        ...
        {
            var closeHandle = this.m_closeHandle;
            if (null != closeHandle) closeHandle.Close();
        }

        public virtual TlsCrypto Crypto { get; }

        public virtual void NotifyCloseHandle(TlsCloseable closeHandle) { this.m_closeHandle = closeHandle; }
        ...
        public virtual bool AllowLegacyResumption() { return false; }

        public virtual int GetMaxCertificateChainLength() { return 10; }

        public virtual int GetMaxHandshakeMessageSize() { return 32768; }

        public virtual short[] GetPskKeyExchangeModes() { return new[] { PskKeyExchangeMode.psk_dhe_ke }; }

        public virtual bool RequiresCloseNotify() { return true; }

        public virtual bool RequiresExtendedMasterSecret() { return false; }

        public virtual bool ShouldCheckSigAlgOfPeerCerts() { return true; }

        public virtual bool ShouldUseExtendedMasterSecret() { return true; }

        public virtual bool ShouldUseExtendedPadding() { return false; }
        ...
        /// <exception cref="IOException" />
        public virtual TlsKeyExchangeFactory GetKeyExchangeFactory() { return new DefaultTlsKeyExchangeFactory(); }
        ...
        public virtual TlsHeartbeat GetHeartbeat() { return null; }

        public virtual short GetHeartbeatPolicy() { return HeartbeatMode.peer_not_allowed_to_send; }
    }
}
