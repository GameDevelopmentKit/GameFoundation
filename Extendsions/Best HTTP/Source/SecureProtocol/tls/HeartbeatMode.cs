...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class HeartbeatMode
    {
        ...
        public static string GetText(short heartbeatMode) { return GetName(heartbeatMode) + "(" + heartbeatMode + ")"; }

        public static bool IsValid(short heartbeatMode) { return heartbeatMode >= peer_allowed_to_send && heartbeatMode <= peer_not_allowed_to_send; }
    }
}
