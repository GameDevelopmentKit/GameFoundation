...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class TlsEccUtilities
    {
        ...
        {
            var curveType = TlsUtilities.ReadUint8(input);
        ...
        /// <exception cref="IOException" />
        public static void WriteECConfig(TlsECConfig ecConfig, Stream output) { WriteNamedECParameters(ecConfig.NamedGroup, output); }
