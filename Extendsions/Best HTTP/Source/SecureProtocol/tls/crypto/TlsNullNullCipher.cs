...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto
{
    ...
    public sealed class TlsNullNullCipher
        : TlsCipher
    {
        public static readonly TlsNullNullCipher Instance = new();

        public int GetCiphertextDecodeLimit(int plaintextLimit) { return plaintextLimit; }

        public int GetCiphertextEncodeLimit(int plaintextLength, int plaintextLimit) { return plaintextLength; }

        public int GetPlaintextLimit(int ciphertextLimit) { return ciphertextLimit; }
        ...
        {
            var result = new byte[headerAllocation + len];
        ...
        public void RekeyDecoder() { throw new TlsFatalAlert(AlertDescription.internal_error); }

        public void RekeyEncoder() { throw new TlsFatalAlert(AlertDescription.internal_error); }
