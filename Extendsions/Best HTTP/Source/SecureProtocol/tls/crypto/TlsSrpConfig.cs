...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto
{
    ...
    public class TlsSrpConfig
    {
        ...
        public BigInteger[] GetExplicitNG() { return (BigInteger[])this.m_explicitNG.Clone(); }

        /// <summary>Set the (N, g) values used for SRP-6.</summary>
        /// <param name="explicitNG">(N, g) as a BigInteger array (N=[0], g=[1]).</param>
        public void SetExplicitNG(BigInteger[] explicitNG) { this.m_explicitNG = (BigInteger[])explicitNG.Clone(); }
    }
}
