...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public abstract class TlsUtilities
    {
        ...
        {
            var d = Platform.CreateHashtable();
        ...
        public static bool IsValidUint8(short i) { return (i & 0xFF) == i; }

        public static bool IsValidUint8(int i) { return (i & 0xFF) == i; }

        public static bool IsValidUint8(long i) { return (i & 0xFFL) == i; }

        public static bool IsValidUint16(int i) { return (i & 0xFFFF) == i; }

        public static bool IsValidUint16(long i) { return (i & 0xFFFFL) == i; }

        public static bool IsValidUint24(int i) { return (i & 0xFFFFFF) == i; }

        public static bool IsValidUint24(long i) { return (i & 0xFFFFFFL) == i; }

        public static bool IsValidUint32(long i) { return (i & 0xFFFFFFFFL) == i; }

        public static bool IsValidUint48(long i) { return (i & 0xFFFFFFFFFFFFL) == i; }

        public static bool IsValidUint64(long i) { return true; }

        public static bool IsSsl(TlsContext context) { return context.ServerVersion.IsSsl; }

        public static bool IsTlsV10(ProtocolVersion version) { return ProtocolVersion.TLSv10.IsEqualOrEarlierVersionOf(version.GetEquivalentTlsVersion()); }

        public static bool IsTlsV10(TlsContext context) { return IsTlsV10(context.ServerVersion); }

        public static bool IsTlsV11(ProtocolVersion version) { return ProtocolVersion.TLSv11.IsEqualOrEarlierVersionOf(version.GetEquivalentTlsVersion()); }

        public static bool IsTlsV11(TlsContext context) { return IsTlsV11(context.ServerVersion); }
        ...
        public static bool IsTlsV12(TlsContext context) { return IsTlsV12(context.ServerVersion); }

        public static bool IsTlsV13(ProtocolVersion version) { return ProtocolVersion.TLSv13.IsEqualOrEarlierVersionOf(version.GetEquivalentTlsVersion()); }

        public static bool IsTlsV13(TlsContext context) { return IsTlsV13(context.ServerVersion); }
        ...
        {
            for (var i = 0; i < u8s.Length; ++i) WriteUint8(u8s[i], output);
        }
        ...
        {
            for (var i = 0; i < u16s.Length; ++i) WriteUint16(u16s[i], output);
        }

        public static void WriteUint16Array(int[] u16s, byte[] buf, int offset)
        {
            for (var i = 0; i < u16s.Length; ++i)
            {
        ...
        public static byte[] DecodeOpaque8(byte[] buf) { return DecodeOpaque8(buf, 0); }
        ...
        public static byte[] DecodeOpaque16(byte[] buf) { return DecodeOpaque16(buf, 0); }
        ...
        public static short[] DecodeUint8ArrayWithUint8Length(byte[] buf)
        {
            ...
            var uints                                = new short[count];
            for (var i = 0; i < count; ++i) uints[i] = ReadUint8(buf, i + 1);
            return uints;
        }
        ...
        {
            var result = new byte[1 + u8s.Length];
        ...
        public static short ReadUint8(byte[] buf, int offset) { return (short)(buf[offset] & 0xff); }
        ...
        {
            var hi = ReadUint24(input);
            var lo = ReadUint24(input);
            return ((hi & 0xffffffffL) << 24) | (lo & 0xffffffffL);
        }

        public static long ReadUint48(byte[] buf, int offset)
        {
            var hi = ReadUint24(buf, offset);
            var lo = ReadUint24(buf, offset + 3);
            return ((hi & 0xffffffffL) << 24) | (lo & 0xffffffffL);
        }
        ...
        public static byte[] ReadAllOrNothing(int length, Stream input)
        {
            ...
            var read = Streams.ReadFully(input, buf);
            if (read == 0)
                return null;
            if (read != length)
                throw new EndOfStreamException();
        ...
        {
            var uints                                = new short[count];
            for (var i = 0; i < count; ++i) uints[i] = ReadUint8(input);
            return uints;
        }
        ...
        {
            var uints                                = new int[count];
            for (var i = 0; i < count; ++i) uints[i] = ReadUint16(input);
            return uints;
        }

        public static ProtocolVersion ReadVersion(byte[] buf, int offset) { return ProtocolVersion.Get(buf[offset], buf[offset + 1]); }
        ...
        {
            var asn1   = new Asn1InputStream(encoding);
        ...
        public static Asn1Object ReadDerObject(byte[] encoding)
        {
             ...
             */
            var result = ReadAsn1Object(encoding);
            var check  = result.GetEncoded(Asn1Encodable.Der);
        ...
        {
            var t = (int)(DateTimeUtilities.CurrentUnixMs() / 1000L);
        ...
        {
            if (crypto.HasSignatureAndHashAlgorithm(alg)) supportedAlgs.Add(alg);
        }

        public static void AddIfSupported(IList supportedGroups, TlsCrypto crypto, int namedGroup)
        {
            if (crypto.HasNamedGroup(namedGroup)) supportedGroups.Add(namedGroup);
        }

        public static void AddIfSupported(IList supportedGroups, TlsCrypto crypto, int[] namedGroups)
        {
            for (var i = 0; i < namedGroups.Length; ++i) AddIfSupported(supportedGroups, crypto, namedGroups[i]);
        }

        public static bool AddToSet(IList s, int i)
        {
            var result = !s.Contains(i);
            if (result) s.Add(i);
            return result;
        }

        public static IList GetDefaultDssSignatureAlgorithms() { return GetDefaultSignatureAlgorithms(SignatureAlgorithm.dsa); }

        public static IList GetDefaultECDsaSignatureAlgorithms() { return GetDefaultSignatureAlgorithms(SignatureAlgorithm.ecdsa); }

        public static IList GetDefaultRsaSignatureAlgorithms() { return GetDefaultSignatureAlgorithms(SignatureAlgorithm.rsa); }
        ...
        {
            var sigAndHashAlg = GetDefaultSignatureAlgorithm(signatureAlgorithm);
        ...
        public static IList GetDefaultSupportedSignatureAlgorithms(TlsContext context)
        {
            ...
            var result = Platform.CreateArrayList(DefaultSupportedSigAlgs.Count);
            foreach (SignatureAndHashAlgorithm sigAndHashAlg in DefaultSupportedSigAlgs) AddIfSupported(result, crypto, sigAndHashAlg);
            return result;
        }
        ...
        {
            var extension_data = GetExtensionData(extensions, extensionType);
        ...
        public static TlsSession ImportSession(byte[] sessionID, SessionParameters sessionParameters) { return new TlsSessionImpl(sessionID, sessionParameters); }
        ...
        public static bool IsNullOrEmpty(short[] array) { return null == array || array.Length < 1; }

        public static bool IsNullOrEmpty(int[] array) { return null == array || array.Length < 1; }

        public static bool IsNullOrEmpty(object[] array) { return null == array || array.Length < 1; }

        public static bool IsNullOrEmpty(string s) { return null == s || s.Length < 1; }

        public static bool IsNullOrEmpty(IList v) { return null == v || v.Count < 1; }
        ...
        {
            var result = Platform.CreateArrayList(3);
            result.Add(SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha1, SignatureAlgorithm.dsa));
            result.Add(SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha1, SignatureAlgorithm.ecdsa));
            result.Add(SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha1, SignatureAlgorithm.rsa));
            return result;
        ...
        public static void EncodeSupportedSignatureAlgorithms(IList supportedSignatureAlgorithms, Stream output)
        {
            ...
            var length = 2 * supportedSignatureAlgorithms.Count;
            CheckUint16(length);
            WriteUint16(length, output);
        ...
        public static IList ParseSupportedSignatureAlgorithms(Stream input)
        {
            ...
            var count                        = length / 2;
            var supportedSignatureAlgorithms = Platform.CreateArrayList(count);
            for (var i = 0; i < count; ++i)
            {
                var sigAndHashAlg = SignatureAndHashAlgorithm.Parse(input);

                if (SignatureAlgorithm.anonymous != sigAndHashAlg.Signature) supportedSignatureAlgorithms.Add(sigAndHashAlg);
            }
        ...
        public static byte[] Clone(byte[] data) { return null == data ? null : data.Length == 0 ? EmptyBytes : (byte[])data.Clone(); }

        public static string[] Clone(string[] s) { return null == s ? null : s.Length < 1 ? EmptyStrings : (string[])s.Clone(); }
        ...
        /// <exception cref="IOException" />
        internal static byte[] CalculateEndPointHash(TlsContext context, TlsCertificate certificate, byte[] enc) { return CalculateEndPointHash(context, certificate, enc, 0, enc.Length); }

        /// <exception cref="IOException" />
        internal static byte[] CalculateEndPointHash(TlsContext context, TlsCertificate certificate, byte[] enc,
            int encOff, int encLen)
        {
            var hashAlgorithm = HashAlgorithm.none;

            var sigAlgOid = certificate.SigAlgOid;
            if (sigAlgOid != null)
            {
                if (PkcsObjectIdentifiers.IdRsassaPss.Id.Equals(sigAlgOid))
                {
                    var pssParams = RsassaPssParameters.GetInstance(certificate.GetSigAlgParams());
                    if (null != pssParams)
                    {
                        var hashOid = pssParams.HashAlgorithm.Algorithm;
                        if (NistObjectIdentifiers.IdSha256.Equals(hashOid))
                            hashAlgorithm = HashAlgorithm.sha256;
                        else if (NistObjectIdentifiers.IdSha384.Equals(hashOid))
                            hashAlgorithm                                                      = HashAlgorithm.sha384;
                        else if (NistObjectIdentifiers.IdSha512.Equals(hashOid)) hashAlgorithm = HashAlgorithm.sha512;
                    }
                }
                else
                {
                    if (CertSigAlgOids.Contains(sigAlgOid)) hashAlgorithm = ((SignatureAndHashAlgorithm)CertSigAlgOids[sigAlgOid]).Hash;
                }
            }
            ...
            {
                var hash = CreateHash(context.Crypto, hashAlgorithm);
                if (hash != null)
                {
        ...
        private static byte[] CalculateFinishedHmac(SecurityParameters securityParameters, TlsSecret baseKey,
            byte[] transcriptHash)
        {
            var prfCryptoHashAlgorithm = securityParameters.PrfCryptoHashAlgorithm;
            var prfHashLength          = securityParameters.PrfHashLength;
        ...
        private static byte[] CalculateFinishedHmac(int prfCryptoHashAlgorithm, int prfHashLength, TlsSecret baseKey,
            byte[] transcriptHash)
        {
            var finishedKey = TlsCryptoUtilities.HkdfExpandLabel(baseKey, prfCryptoHashAlgorithm, "finished",
        ...
        {
            var sp = context.SecurityParameters;
        ...
        {
            var prfHashLength = TlsCryptoUtilities.GetHashOutputSize(pskCryptoHashAlgorithm);

            var label               = isExternalPsk ? "ext binder" : "res binder";
            var emptyTranscriptHash = crypto.CreateHash(pskCryptoHashAlgorithm).CalculateHash();

            var binderKey = DeriveSecret(pskCryptoHashAlgorithm, prfHashLength, earlySecret, label,
                emptyTranscriptHash);
        ...
        internal static byte[] CalculateVerifyData(TlsContext context, TlsHandshakeHash handshakeHash, bool isServer)
        {
            ...
            {
                var baseKey = isServer
                    ? securityParameters.BaseKeyServer
                    : securityParameters.BaseKeyClient;
                var transcriptHash = GetCurrentPrfHash(handshakeHash);

                return CalculateFinishedHmac(securityParameters, baseKey, transcriptHash);
            }

            if (negotiatedVersion.IsSsl) return Ssl3Utilities.CalculateVerifyData(handshakeHash, isServer);

            var asciiLabel = isServer ? ExporterLabel.server_finished : ExporterLabel.client_finished;
            var prfHash    = GetCurrentPrfHash(handshakeHash);

            var master_secret      = securityParameters.MasterSecret;
            var verify_data_length = securityParameters.VerifyDataLength;
            ...
            TlsSecret sharedSecret)
        {
            var crypto              = context.Crypto;
            var securityParameters  = context.SecurityParameters;
            var cryptoHashAlgorithm = securityParameters.PrfCryptoHashAlgorithm;
            var zeros               = crypto.HkdfInit(cryptoHashAlgorithm);
            var emptyTranscriptHash = crypto.CreateHash(cryptoHashAlgorithm).CalculateHash();

            var earlySecret = pskEarlySecret;
            if (null == earlySecret)
                earlySecret = crypto
                    .HkdfInit(cryptoHashAlgorithm)
                    .HkdfExtract(cryptoHashAlgorithm, zeros);

            if (null == sharedSecret) sharedSecret = zeros;

            var handshakeSecret = DeriveSecret(securityParameters, earlySecret, "derived", emptyTranscriptHash)
                .HkdfExtract(cryptoHashAlgorithm, sharedSecret);

            if (sharedSecret != zeros) sharedSecret.Destroy();

            var masterSecret = DeriveSecret(securityParameters, handshakeSecret, "derived", emptyTranscriptHash)
                .HkdfExtract(cryptoHashAlgorithm, zeros);
        ...
        {
            var securityParameters = context.SecurityParameters;
            var phaseSecret        = securityParameters.MasterSecret;
        ...
        {
            var securityParameters = context.SecurityParameters;
            var phaseSecret        = securityParameters.EarlySecret;
        ...
        {
            var securityParameters = context.SecurityParameters;
            var phaseSecret        = securityParameters.HandshakeSecret;
        ...
        internal static void Update13TrafficSecretLocal(TlsContext context) { Update13TrafficSecret(context, context.IsServer); }

        internal static void Update13TrafficSecretPeer(TlsContext context) { Update13TrafficSecret(context, !context.IsServer); }
        ...
        private static void Update13TrafficSecret(TlsContext context, bool forServer)
        {
            ...
            if (null != current) current.Destroy();
        }
        ...
        internal static int GetPrfAlgorithm(SecurityParameters securityParameters, int cipherSuite)
        {
            ...
            var isTlsV13        = IsTlsV13(negotiatedVersion);
            var isTlsV12Exactly = !isTlsV13 && IsTlsV12(negotiatedVersion);
            var isSsl           = negotiatedVersion.IsSsl;
        ...
        internal static int[] GetPrfAlgorithms13(int[] cipherSuites)
        {
            ...
            for (var i = 0; i < cipherSuites.Length; ++i)
            {
                ...
                if (prfAlgorithm >= 0 && !Arrays.Contains(result, prfAlgorithm)) result[count++] = prfAlgorithm;
            }
            ...
            byte[] extraSignatureInput, DigestInputBuffer buf)
        {
            ...
            var h = algorithm == null
                ? new CombinedHash(crypto)
                : CreateHash(crypto, algorithm.Hash);

            var sp = context.SecurityParameters;
            // NOTE: The implicit copy here is intended (and important)
            var randoms = Arrays.Concatenate(sp.ClientRandom, sp.ServerRandom);
            h.Update(randoms, 0, randoms.Length);

            if (null != extraSignatureInput) h.Update(extraSignatureInput, 0, extraSignatureInput.Length);
            ...
            Stream output)
        {
            ...
            if (null != extraSignatureInput) output.Write(extraSignatureInput, 0, extraSignatureInput.Length);
        ...
        {
            var securityParameters = clientContext.SecurityParameters;
            var negotiatedVersion  = securityParameters.NegotiatedVersion;
             ...
             */
            var signatureAndHashAlgorithm = GetSignatureAndHashAlgorithm(negotiatedVersion,
                credentialedSigner);
            ...
            else
            {
                ...
                {
                    var signatureScheme     = SignatureScheme.From(signatureAndHashAlgorithm);
                    var cryptoHashAlgorithm = SignatureScheme.GetCryptoHashAlgorithm(signatureScheme);
        ...
        {
            var signatureAndHashAlgorithm = credentialedSigner.SignatureAndHashAlgorithm;
            if (null == signatureAndHashAlgorithm)
                throw new TlsFatalAlert(AlertDescription.internal_error);

            var contextString = context.IsServer
                ? "TLS 1.3, server CertificateVerify"
                : "TLS 1.3, client CertificateVerify";

            var signature = Generate13CertificateVerify(context.Crypto, credentialedSigner, contextString,
        ...
        {
            var streamSigner = credentialedSigner.GetStreamSigner();

            var header  = GetCertificateVerifyHeader(contextString);
            var prfHash = GetCurrentPrfHash(handshakeHash);

            if (null != streamSigner)
            {
                var output = streamSigner.GetOutputStream();
            ...
            var tlsHash = crypto.CreateHash(cryptoHashAlgorithm);
            tlsHash.Update(header, 0, header.Length);
            tlsHash.Update(prfHash, 0, prfHash.Length);
            var hash = tlsHash.CalculateHash();
        ...
        {
            var   securityParameters = serverContext.SecurityParameters;
            var   clientCertificate  = securityParameters.PeerCertificate;
            var   verifyingCert      = clientCertificate.GetCertificateAt(0);
            var   sigAndHashAlg      = certificateVerify.Algorithm;
            short signatureAlgorithm;
            ...
            if (null == sigAndHashAlg)
            {
                ...
                var clientCertType = GetLegacyClientCertType(signatureAlgorithm);
            ...
            try
            {
                var verifier       = verifyingCert.CreateVerifier(signatureAlgorithm);
                var streamVerifier = verifier.GetStreamVerifier(certificateVerify);
                ...
                else
                {
                    ...
                    {
                        var signatureScheme     = SignatureScheme.From(sigAndHashAlg);
                        var cryptoHashAlgorithm = SignatureScheme.GetCryptoHashAlgorithm(signatureScheme);
            ...
            if (!verified) throw new TlsFatalAlert(AlertDescription.decrypt_error);
        }
            ...
            CertificateRequest certificateRequest, DigitallySigned certificateVerify, TlsHandshakeHash handshakeHash)
        {
            ...
            try
            {
                var verifier = verifyingCert.CreateVerifier(signatureScheme);
        ...
        {
            var securityParameters = clientContext.SecurityParameters;
            var serverCertificate  = securityParameters.PeerCertificate;
            var verifyingCert      = serverCertificate.GetCertificateAt(0);
            ...
            TlsVerifier verifier, string contextString, TlsHandshakeHash handshakeHash)
        {
            ...
            {
                var output = streamVerifier.GetOutputStream();
                output.Write(header, 0, header.Length);
                output.Write(prfHash, 0, prfHash.Length);
                return streamVerifier.IsVerified();
            }

            var signatureScheme     = SignatureScheme.From(certificateVerify.Algorithm);
            var cryptoHashAlgorithm = SignatureScheme.GetCryptoHashAlgorithm(signatureScheme);
        ...
        {
            var count                              = contextString.Length;
            var header                             = new byte[64 + count + 1];
            for (var i = 0; i < 64; ++i) header[i] = 0x20;
            for (var i = 0; i < count; ++i)
            {
                var c = contextString[i];
                header[64 + i] = (byte)c;
            }
            ...
            byte[] extraSignatureInput, DigestInputBuffer digestBuffer)
        {
             ...
             * RFC 5246 4.7. digitally-signed element needs SignatureAndHashAlgorithm from TLS 1.2
             */
            var algorithm    = GetSignatureAndHashAlgorithm(context, credentials);
            var streamSigner = credentials.GetStreamSigner();
            ...
            {
                var hash = CalculateSignatureHash(context, algorithm, extraSignatureInput, digestBuffer);
                signature = credentials.GenerateRawSignature(hash);
            }

            var digitallySigned = new DigitallySigned(algorithm, signature);
        ...
        {
            var digitallySigned = DigitallySigned.Parse(context, signatureInput);

            var securityParameters   = context.SecurityParameters;
            var keyExchangeAlgorithm = securityParameters.KeyExchangeAlgorithm;

            var   sigAndHashAlg = digitallySigned.Algorithm;
            short signatureAlgorithm;
            ...
            var verifier       = serverCertificate.CreateVerifier(signatureAlgorithm);
            var streamVerifier = verifier.GetStreamVerifier(digitallySigned);
            ...
            {
                var hash = CalculateSignatureHash(context, sigAndHashAlg, null, digestBuffer);
        ...
        internal static void TrackHashAlgorithms(TlsHandshakeHash handshakeHash, IList supportedSignatureAlgorithms)
        {
            if (supportedSignatureAlgorithms != null)
                foreach (SignatureAndHashAlgorithm signatureAndHashAlgorithm in supportedSignatureAlgorithms)
                {
                    ...
                    else if (HashAlgorithm.Intrinsic == signatureAndHashAlgorithm.Hash) handshakeHash.ForceBuffering();
                }
        }
        ...
        {
            var v = Platform.CreateArrayList(1);
            v.Add(obj);
            return v;
        }
        ...
        {
            var encryptionAlgorithm = GetEncryptionAlgorithm(cipherSuite);
        ...
        public static IList GetKeyExchangeAlgorithms(int[] cipherSuites)
        {
            ...
            {
                for (var i = 0; i < cipherSuites.Length; ++i) AddToSet(result, GetKeyExchangeAlgorithm(cipherSuites[i]));
                result.Remove(-1);
            }
        ...
        public static IList GetNamedGroupRoles(int[] cipherSuites) { return GetNamedGroupRoles(GetKeyExchangeAlgorithms(cipherSuites)); }
        ...
        /// <exception cref="IOException" />
        public static bool IsAeadCipherSuite(int cipherSuite) { return CipherType.aead == GetCipherType(cipherSuite); }

        /// <exception cref="IOException" />
        public static bool IsBlockCipherSuite(int cipherSuite) { return CipherType.block == GetCipherType(cipherSuite); }

        /// <exception cref="IOException" />
        public static bool IsStreamCipherSuite(int cipherSuite) { return CipherType.stream == GetCipherType(cipherSuite); }
        ...
        {
            var clientCertificateType = SignatureAlgorithm.GetClientCertificateType(signatureAlgorithm);
        ...
        public static bool IsValidVersionForCipherSuite(int cipherSuite, ProtocolVersion version)
        {
            ...
            var minimumVersion = GetMinimumVersion(cipherSuite);
            ...
            IList sigHashAlgs, short signatureAlgorithm)
        {
            ...
            if (sigHashAlgs == null)
                ...
                foreach (SignatureAndHashAlgorithm sigHashAlg in sigHashAlgs)
                {
                    ...
                    var current = result.Hash;
                    if (current < MinimumHashPreferred)
                    {
                        if (hash > current) result = sigHashAlg;
                    }
                ...
                public static IList GetUsableSignatureAlgorithms(IList sigHashAlgs)
                {
                    if (sigHashAlgs == null)
                    {
                        var v = Platform.CreateArrayList(3);
                    ...
                    else
                    {
                        ...
                        foreach (SignatureAndHashAlgorithm sigHashAlg in sigHashAlgs)
                            ...
                            {
                                var sigAlg = sigHashAlg.Signature;
                ...
                public static int[] GetCommonCipherSuites(int[] peerCipherSuites, int[] localCipherSuites, bool useLocalOrder)
                {
                    ...
                    if (count < limit) candidates = Arrays.CopyOf(candidates, count);

                    return candidates;
                }

                public static int[] GetSupportedCipherSuites(TlsCrypto crypto, int[] suites) { return GetSupportedCipherSuites(crypto, suites, 0, suites.Length); }

                public static int[] GetSupportedCipherSuites(TlsCrypto crypto, int[] suites, int suitesOff, int suitesCount)
                {
                    var supported = new int[suitesCount];
                    var count     = 0;

                    for (var i = 0; i < suitesCount; ++i)
                    {
                        var suite                                                     = suites[suitesOff + i];
                        if (IsSupportedCipherSuite(crypto, suite)) supported[count++] = suite;
                    }

                    if (count < suitesCount) supported = Arrays.CopyOf(supported, count);
                ...
                internal static byte[] GetCurrentPrfHash(TlsHandshakeHash handshakeHash) { return handshakeHash.ForkPrfHash().CalculateHash(); }

                internal static void SealHandshakeHash(TlsContext context, TlsHandshakeHash handshakeHash, bool forceBuffering)
                {
                    if (forceBuffering || !context.Crypto.HasAllRawSignatureAlgorithms()) handshakeHash.ForceBuffering();
                ...
                {
                    var cryptoHashAlgorithm = TlsCryptoUtilities.GetHash(hashAlgorithm);
                ...
                {
                    var factory = client.GetKeyExchangeFactory();
                ...
                {
                    var factory = server.GetKeyExchangeFactory();
                ...
                {
                    var securityParameters = clientContext.SecurityParameters;
                    var keyExchange        = CreateKeyExchangeClient(client, securityParameters.KeyExchangeAlgorithm);
                ...
                {
                    var securityParameters = serverContext.SecurityParameters;
                    var keyExchange        = CreateKeyExchangeServer(server, securityParameters.KeyExchangeAlgorithm);
                ...
                {
                    var securityParameters  = context.SecurityParameters;
                    var cipherSuite         = securityParameters.CipherSuite;
                    var encryptionAlgorithm = GetEncryptionAlgorithm(cipherSuite);
                    var macAlgorithm        = GetMacAlgorithm(cipherSuite);
                ...
                {
                    var securityParameters = context.SecurityParameters;
                    var clientCertTypes    = securityParameters.ClientCertTypes;
                    var serverSigAlgsCert  = securityParameters.ServerSigAlgsCert;

                    var trustAnchorPos = clientCertPath.Length - 1;
                    for (var i = 0; i < trustAnchorPos; ++i)
                    {
                        var subjectCert = clientCertPath[i];
                        var issuerCert  = clientCertPath[i + 1];

                        var sigAndHashAlg = GetCertSigAndHashAlg(subjectCert, issuerCert);
                        ...
                        else if (null == serverSigAlgsCert)
                        {
                            ...
                            if (null != clientCertTypes)
                                for (var j = 0; j < clientCertTypes.Length; ++j)
                                {
                                    var signatureAlgorithm = GetLegacySignatureAlgorithmClientCert(clientCertTypes[j]);
                        ...
                        if (!valid) throw new TlsFatalAlert(AlertDescription.bad_certificate);
                    }
                }
                ...
                private static void CheckSigAlgOfServerCerts(TlsContext context, TlsCertificate[] serverCertPath)
                {
                     ...
                     */
                    if (clientSigAlgs == clientSigAlgsCert || IsTlsV13(securityParameters.NegotiatedVersion)) clientSigAlgs = null;

                    var trustAnchorPos = serverCertPath.Length - 1;
                    for (var i = 0; i < trustAnchorPos; ++i)
                    {
                        var subjectCert = serverCertPath[i];
                        var issuerCert  = serverCertPath[i + 1];
                        ...
                        else if (null == clientSigAlgsCert)
                        {
                             ...
                             */
                            var signatureAlgorithm = GetLegacySignatureAlgorithmServerCert(
                    ...
                    IDictionary serverExtensions)
                {
                     ...
                     */
                    var tlsFeatures = serverCertificate.GetCertificateAt(0).GetExtension(TlsObjectIdentifiers.id_pe_tlsfeature);
                    if (tlsFeatures != null)
                        foreach (DerInteger tlsExtension in Asn1Sequence.GetInstance(ReadDerObject(tlsFeatures)))
                        {
                            var extensionType = tlsExtension.IntValueExact;
                    ...
                    TlsKeyExchange keyExchange, TlsServer server)
                {
                    ...
                    var isTlsV13 = IsTlsV13(securityParameters.NegotiatedVersion);
                    if (isTlsV13)
                    {
                    ...
                    TlsAuthentication clientAuthentication, IDictionary clientExtensions, IDictionary serverExtensions)
                {
                    ...
                    if (!isTlsV13) keyExchange.ProcessServerCertificate(serverCertificate);
                ...
                {
                    var sigAlgOid = subjectCert.SigAlgOid;
                    ...
                    if (null != sigAlgOid)
                    {
                        ...
                        var pssParams = RsassaPssParameters.GetInstance(subjectCert.GetSigAlgParams());
                        if (null != pssParams)
                        {
                            var hashOid = pssParams.HashAlgorithm.Algorithm;
                            if (NistObjectIdentifiers.IdSha256.Equals(hashOid))
                ...
                {
                    var validClientCertificateTypes = keyExchange.GetClientCertificateTypes();
                    ...
                    short[] validClientCertificateTypes)
                {
                    ...
                    var retained = RetainAll(certificateRequest.CertificateTypes, validClientCertificateTypes);
                ...
                {
                    var retained = new short[Math.Min(retainer.Length, elements.Length)];
                ...
                {
                    var len = downgradeMarker.Length;
                ...
                internal static void CheckDowngradeMarker(ProtocolVersion version, byte[] randomBlock)
                {
                    ...
                    if (version.IsEqualOrEarlierVersionOf(ProtocolVersion.TLSv11)) CheckDowngradeMarker(randomBlock, DowngradeTlsV11);
                    if (version.IsEqualOrEarlierVersionOf(ProtocolVersion.TLSv12)) CheckDowngradeMarker(randomBlock, DowngradeTlsV12);
                }
                    ...
                    MemoryStream buf)
                {
                    ...
                    var serverCertificate = Certificate.Parse(options, clientContext, buf, endPointHash);
                    ...
                    MemoryStream buf)
                {
                    ...
                    var serverCertificate = Certificate.Parse(options, clientContext, buf, null);
                    ...
                    IDictionary clientExtensions)
                {
                    ...
                    var clientAgreements = Platform.CreateHashtable(3);
                    var clientShares     = Platform.CreateArrayList(2);
                ...
                {
                    int[] supportedGroups  = { keyShareGroup };
                    var   keyShareGroups   = VectorOfOne(keyShareGroup);
                    var   clientAgreements = Platform.CreateHashtable(1);
                    var   clientShares     = Platform.CreateArrayList(1);
                    ...
                    IDictionary clientAgreements, IList clientShares)
                {
                    ...
                    {
                        var supportedGroup = supportedGroups[i];
                        ...
                        {
                            if (crypto.HasECDHAgreement()) agreement = crypto.CreateECDomain(new TlsECConfig(supportedGroup)).CreateECDH();
                        }
                        else if (NamedGroup.RefersToASpecificFiniteField(supportedGroup))
                        {
                            if (crypto.HasDHAgreement()) agreement = crypto.CreateDHDomain(new TlsDHConfig(supportedGroup, true)).CreateDH();
                        }

                        if (null != agreement)
                        {
                            var key_exchange = agreement.GenerateEphemeral();
                            var clientShare  = new KeyShareEntry(supportedGroup, key_exchange);
                ...
                internal static KeyShareEntry SelectKeyShare(IList clientShares, int keyShareGroup)
                {
                    ...
                    {
                        var clientShare = (KeyShareEntry)clientShares[0];
                        if (null != clientShare && clientShare.NamedGroup == keyShareGroup) return clientShare;
                    }
                    ...
                    IList clientShares, int[] clientSupportedGroups, int[] serverSupportedGroups)
                {
                    if (null != clientShares && !IsNullOrEmpty(clientSupportedGroups) && !IsNullOrEmpty(serverSupportedGroups))
                        ...
                        {
                            var group = clientShare.NamedGroup;
                    ...
                    int[] clientSupportedGroups, int[] serverSupportedGroups)
                {
                    if (!IsNullOrEmpty(clientSupportedGroups) && !IsNullOrEmpty(serverSupportedGroups))
                        foreach (var group in clientSupportedGroups)
                        {
                            if (!NamedGroup.CanBeNegotiated(group, negotiatedVersion))
                                continue;
                ...
                internal static byte[] GetSessionID(TlsSession tlsSession)
                {
                    if (null != tlsSession)
                    {
                        var sessionID = tlsSession.SessionID;
                        if (null != sessionID
                            && sessionID.Length > 0
                            && sessionID.Length <= 32)
                            return sessionID;
                ...
                {
                    var clientHelloHash = GetCurrentPrfHash(handshakeHash);
                    handshakeHash.Reset();

                    var length = clientHelloHash.Length;
                    CheckUint8(length);

                    var synthetic = new byte[4 + length];
                ...
                internal static TlsCredentials EstablishServerCredentials(TlsServer server) { return ValidateCredentials(server.GetCredentials()); }

                internal static TlsCredentialedSigner Establish13ServerCredentials(TlsServer server) { return Validate13Credentials(server.GetCredentials()); }
                    ...
                    CertificateRequest certificateRequest)
                {
                    ...
                    if (null == securityParameters.ServerSigAlgsCert) securityParameters.m_serverSigAlgsCert = securityParameters.ServerSigAlgs;
                }
                ...
                internal static void NegotiatedCipherSuite(SecurityParameters securityParameters, int cipherSuite)
                {
                    ...
                    var prfAlgorithm = GetPrfAlgorithm(securityParameters, cipherSuite);
                ...
                internal static void NegotiatedVersion(SecurityParameters securityParameters)
                {
                    ...
                    if (null == securityParameters.ClientSigAlgs) securityParameters.m_clientSigAlgs = GetLegacySupportedSignatureAlgorithms();

                    if (null == securityParameters.ClientSigAlgsCert) securityParameters.m_clientSigAlgsCert = securityParameters.ClientSigAlgs;
                }
                ...
                public static TlsSecret GenerateEncryptedPreMasterSecret(TlsContext context, TlsEncryptor encryptor,
                    Stream output)
                {
                    var version                  = context.RsaPreMasterSecretVersion;
                    var preMasterSecret          = context.Crypto.GenerateRsaPreMasterSecret(version);
                    var encryptedPreMasterSecret = preMasterSecret.Encrypt(encryptor);
        ...
        internal static void AddPreSharedKeyToClientExtensions(TlsPsk[] psks, IDictionary clientExtensions)
                {
                    var identities = Platform.CreateArrayList(psks.Length);
        ...
        internal static OfferedPsks.BindersConfig AddPreSharedKeyToClientHello(TlsClientContext clientContext,
                    TlsClient client, IDictionary clientExtensions, int[] offeredCipherSuites)
                {
                    ...
                    var pskExternals = GetPskExternalsClient(client, offeredCipherSuites);
                    if (null == pskExternals)
                        return null;

                    var pskKeyExchangeModes = client.GetPskKeyExchangeModes();
                    if (IsNullOrEmpty(pskKeyExchangeModes))
                        throw new TlsFatalAlert(AlertDescription.internal_error,
                            "External PSKs configured but no PskKeyExchangeMode available");

                    var pskEarlySecrets = GetPskEarlySecrets(clientContext.Crypto, pskExternals);

                    var bindersSize = OfferedPsks.GetBindersSize(pskExternals);
        ...
        internal static OfferedPsks.BindersConfig AddPreSharedKeyToClientHelloRetry(TlsClientContext clientContext,
                    OfferedPsks.BindersConfig clientBinders, IDictionary clientExtensions)
                {
                    ...
                    var prfAlgorithm = GetPrfAlgorithm13(securityParameters.CipherSuite);

                    var pskIndices = GetPskIndices(clientBinders.m_psks, prfAlgorithm);
                    if (pskIndices.Count < 1)
                        return null;

                    var result = clientBinders;

                    var count = pskIndices.Count;
                    if (count < clientBinders.m_psks.Length)
                    {
                        var psks         = new TlsPsk[count];
                        var earlySecrets = new TlsSecret[count];

                        for (var i = 0; i < count; ++i)
                        {
                            var j = (int)pskIndices[i];

                            psks[i]         = clientBinders.m_psks[j];
                            earlySecrets[i] = clientBinders.m_earlySecrets[j];
                        }

                        var bindersSize = OfferedPsks.GetBindersSize(psks);
                ...
                {
                    var handshakeHashUpdated = false;

                    var offeredPsks = TlsExtensionsUtilities.GetPreSharedKeyClientHello(clientHelloExtensions);
                    if (null != offeredPsks)
                    {
                        var pskKeyExchangeModes = TlsExtensionsUtilities.GetPskKeyExchangeModesExtension(
                        ...
                        if (Arrays.Contains(pskKeyExchangeModes, PskKeyExchangeMode.psk_dhe_ke))
                        {
                            ...
                            var psk = server.GetExternalPsk(offeredPsks.Identities);
                            if (null != psk)
                            {
                                var index = offeredPsks.GetIndexOfIdentity(new PskIdentity(psk.Identity, 0L));
                                if (index >= 0)
                                {
                                    var binder = (byte[])offeredPsks.Binders[index];

                                    var crypto      = serverContext.Crypto;
                                    var earlySecret = GetPskEarlySecret(crypto, psk);
                                    ...
                                    byte[] transcriptHash;
                                    {
                                        ...
                                        var bindersSize = offeredPsks.BindersSize;
                                    ...
                                    var calculatedBinder = CalculatePskBinder(crypto, isExternalPsk, pskCryptoHashAlgorithm,
                    ...
                    if (!handshakeHashUpdated) clientHelloMessage.UpdateHash(handshakeHash);
                ...
                {
                    var cryptoHashAlgorithm = TlsCryptoUtilities.GetHashForPrf(psk.PrfAlgorithm);
                ...
                internal static TlsSecret[] GetPskEarlySecrets(TlsCrypto crypto, TlsPsk[] psks)
                {
                    ...
                    var earlySecrets                                = new TlsSecret[count];
                    for (var i = 0; i < count; ++i) earlySecrets[i] = GetPskEarlySecret(crypto, psks[i]);
                    return earlySecrets;
                }
                ...
                internal static TlsPskExternal[] GetPskExternalsClient(TlsClient client, int[] offeredCipherSuites)
                {
                    ...
                    for (var i = 0; i < count; ++i)
                    {
                        var pskExternal = externalPsks[i] as TlsPskExternal;
                        if (null == pskExternal)
                            throw new TlsFatalAlert(AlertDescription.internal_error,
                ...
                {
                    var v = Platform.CreateArrayList(psks.Length);
                    for (var i = 0; i < psks.Length; ++i)
