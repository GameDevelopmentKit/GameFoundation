...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : TlsPeer
    {
        ...
        /// </remarks>
        /// <returns>
        ///     A <see cref="TlsSession" /> representing the resumable session to be used for this connection, or
        ...
        /// <returns>
        ///     an <see cref="IList" /> of <see cref="TlsPskExternal" /> instances, or null if none should be
        ///     offered.
        /// </returns>
        ...
        /// </remarks>
        /// <returns>
        ///     an <see cref="IList" /> of <see cref="NamedGroup">named group</see> values, possibly empty or null.
        /// </returns>
        ...
        /// </remarks>
        /// <param name="session">
        ///     The <see cref="TlsSession" /> representing the resumable session to be offered for
