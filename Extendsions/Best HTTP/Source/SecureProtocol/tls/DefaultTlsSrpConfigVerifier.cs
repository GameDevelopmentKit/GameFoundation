...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : TlsSrpConfigVerifier
    {
        ...
        public DefaultTlsSrpConfigVerifier(IList groups) { this.m_groups = Platform.CreateArrayList(groups); }

        public virtual bool Accept(TlsSrpConfig srpConfig)
        {
            foreach (Srp6Group group in this.m_groups)
        ...
        {
            var ng = a.GetExplicitNG();
            return this.AreParametersEqual(ng[0], b.N) && this.AreParametersEqual(ng[1], b.G);
        }
