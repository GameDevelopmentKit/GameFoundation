		...
		: IBlockCipher
    {
        ...
        */
            ...
            ICipherParameters parameters)
        {
            ...
            var keyBits = this.workingKey.Length * 8;
            switch (keyBits)
            {
                case 128:
                case 192:
        ...
        private void SetKey(byte[] key)
        {
            ...
            */
            ...
            for (int i=0; i < TOTAL_SUBKEYS / 2 ; i++)
            {
                ...
                gSubKeys[i*2]            =  A;
                A                        += B;
                this.gSubKeys[i * 2 + 1] =  Integers.RotateLeft(A, SK_ROTL);
            }
        ...
        */
        private void EncryptBlock(
            ...
            int dstIndex)
        {
            var x0 = (int)Pack.LE_To_UInt32(src, srcIndex) ^ this.gSubKeys[INPUT_WHITEN];
            var x1 = (int)Pack.LE_To_UInt32(src, srcIndex + 4) ^ this.gSubKeys[INPUT_WHITEN + 1];
            var x2 = (int)Pack.LE_To_UInt32(src, srcIndex + 8) ^ this.gSubKeys[INPUT_WHITEN + 2];
            var x3 = (int)Pack.LE_To_UInt32(src, srcIndex + 12) ^ this.gSubKeys[INPUT_WHITEN + 3];
            ...
            Pack.UInt32_To_LE((uint)(x2 ^ this.gSubKeys[OUTPUT_WHITEN]), dst, dstIndex);
            Pack.UInt32_To_LE((uint)(x3 ^ this.gSubKeys[OUTPUT_WHITEN + 1]), dst, dstIndex + 4);
            Pack.UInt32_To_LE((uint)(x0 ^ this.gSubKeys[OUTPUT_WHITEN + 2]), dst, dstIndex + 8);
            Pack.UInt32_To_LE((uint)(x1 ^ this.gSubKeys[OUTPUT_WHITEN + 3]), dst, dstIndex + 12);
        }
        ...
        */
        private void DecryptBlock(
            ...
            int dstIndex)
        {
            var x2 = (int)Pack.LE_To_UInt32(src, srcIndex) ^ this.gSubKeys[OUTPUT_WHITEN];
            var x3 = (int)Pack.LE_To_UInt32(src, srcIndex + 4) ^ this.gSubKeys[OUTPUT_WHITEN + 1];
            var x0 = (int)Pack.LE_To_UInt32(src, srcIndex + 8) ^ this.gSubKeys[OUTPUT_WHITEN + 2];
            var x1 = (int)Pack.LE_To_UInt32(src, srcIndex + 12) ^ this.gSubKeys[OUTPUT_WHITEN + 3];
            ...
            Pack.UInt32_To_LE((uint)(x0 ^ this.gSubKeys[INPUT_WHITEN]), dst, dstIndex);
            Pack.UInt32_To_LE((uint)(x1 ^ this.gSubKeys[INPUT_WHITEN + 1]), dst, dstIndex + 4);
            Pack.UInt32_To_LE((uint)(x2 ^ this.gSubKeys[INPUT_WHITEN + 2]), dst, dstIndex + 8);
            Pack.UInt32_To_LE((uint)(x3 ^ this.gSubKeys[INPUT_WHITEN + 3]), dst, dstIndex + 12);
        }
