        ...
        : IBlockCipher
    {
        ...
        */
        ...
        private void DecryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
        {
            ...
            kw = KW[0];
            C0 = Si[r0 & 255] ^ ((uint)Si[(r3 >> 8) & 255] << 8) ^ ((uint)Si[(r2 >> 16) & 255] << 16) ^ ((uint)Si[(r1 >> 24) & 255] << 24) ^ kw[0];
            C1 = Si[r1 & 255] ^ ((uint)Si[(r0 >> 8) & 255] << 8) ^ ((uint)Si[(r3 >> 16) & 255] << 16) ^ ((uint)Si[(r2 >> 24) & 255] << 24) ^ kw[1];
            C2 = Si[r2 & 255] ^ ((uint)Si[(r1 >> 8) & 255] << 8) ^ ((uint)Si[(r0 >> 16) & 255] << 16) ^ ((uint)Si[(r3 >> 24) & 255] << 24) ^ kw[2];
            C3 = Si[r3 & 255] ^ ((uint)Si[(r2 >> 8) & 255] << 8) ^ ((uint)Si[(r1 >> 16) & 255] << 16) ^ ((uint)Si[(r0 >> 24) & 255] << 24) ^ kw[3];
