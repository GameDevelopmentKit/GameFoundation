...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Crypto.Modes.Gcm
{
    ...
    internal static class GcmUtilities
    {
        ...
        internal static void AsUlongs(byte[] x, ulong[] z, int zOff) { Pack.BE_To_UInt64(x, 0, z, zOff, 2); }
