...
namespace vietlabs.fr2
{
    ...
    public class FR2_Bookmark : IRefDraw
    {
        ...
        public FR2_Bookmark(IWindow window)
        {
            ...
            this.drawer.messageNoRefs = "Do bookmark something!";
        ...
        private void DrawButtons(Rect rect)
        {
            ...
            GUILayout.BeginArea(rect);
            {
                GUILayout.BeginHorizontal();
                {
                    ...
                    if (GUILayout.Button("CSV")) FR2_Export.ExportCSV(this.refs.Values.ToArray());

                    if (GUILayout.Button("Delete"))
                    {
                        FR2_Unity.BackupAndDeleteAssets(this.refs.Values.ToArray());
                        Clear();
                        GUIUtility.ExitGUI();
                    }
                }
        ...
        public void RefreshView()
        {
            ...
            foreach (var instId in instSet) this.refs.Add(instId, new FR2_SceneRef(0, EditorUtility.InstanceIDToObject(int.Parse(instId))));
