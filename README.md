...
```
"caojweldjflwendl.Script",
"caojweldjflwendl.AssetLibrary",
"caojweldjflwendl.BlueprintFlow",
"caojweldjflwendl.UIModule",
"caojweldjflwendl.Utilities",
"caojweldjflwendl.Models",
"caojweldjflwendl.Network.HttpServices",
```
...
Then, you add Game Foundation Core by https://github.com/GameDevelopmentKit/caojweldjflwendl.git
...
```
{
  "dependencies": {
    ...
    "com.gdk.core": "https://github.com/GameDevelopmentKit/caojweldjflwendl.git",
    ...
  },
}
```
...
```
git submodule add git@github.com:GameDevelopmentKit/caojweldjflwendl.git .\Packages\com.gdk.core
```
